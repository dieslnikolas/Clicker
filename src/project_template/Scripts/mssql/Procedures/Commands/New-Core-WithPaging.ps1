...
.\Scripts\MsSQL\Procedures\Mvc\Core\Common\New-Output-Model-WithPaging.ps1 $obj | Out-File $filepath
...
.\Scripts\MsSQL\Procedures\Mvc\Core\Services\New-Service-Interface-WithPaging.ps1 $obj | Out-File $filepath
...
.\Scripts\MsSQL\Procedures\Mvc\Core\Services\New-Service-WithPaging.ps1 $obj | Out-File $filepath
