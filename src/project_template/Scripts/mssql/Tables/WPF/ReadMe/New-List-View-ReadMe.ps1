...
Add-Line('        public const string {0}ListViewTabItemTemplate = "{0}ListViewTabItemTemplate";' -f $data.Metadata.Name, $data.Metadata.Prefix)
Add-Line('        public const string {0}ParentDetailViewTabItemTemplate = "{0}ParentDetailViewTabItemTemplate";' -f $data.Metadata.Name, $data.Metadata.Prefix)
Add-Line('~~~')
Add-Line('')
