...
var Logger = /** @class */ (function () {
    function Logger() {
        ...
        var pathF = path.resolve(electron_1.app.getPath('temp'), 'Clicker', "log.txt");
        log4js.configure({
            appenders: {
                toFile: {
     ...
     * IPC method
     */
    Logger.prototype.loggerIpc = function () {
        var _this = this;
        electron_1.ipcMain.handle('logger-ipc', function (event, message, logSeverity) { return __awaiter(_this, void 0, void 0, function () {
