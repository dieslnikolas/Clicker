...
# nastavit vysokou prioritu pro itadocs.geis.cz 
route delete 10.20.230.43
route add 10.20.230.43 mask 255.255.255.255 $GATEWAY METRIC 20 IF $VPN_CONNECTION_INTERFACE