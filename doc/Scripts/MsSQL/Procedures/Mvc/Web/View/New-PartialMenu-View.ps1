...
# usingy
Add-Line('@model {0}.Controllers{1}{2}{3}{3}{4}Model' -f $data.Metadata.AppNamespace, ('.',('.{0}.'-f $data.Metadata.Modules))[![string]::IsNullOrEmpty($data.Metadata.Modules)], $data.Metadata.PluralName, '.DetailHeader', $data.Metadata.Name)
